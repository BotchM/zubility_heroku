$(document).ready(function() {
  ...
  function updateParticipants(participants, current) {
   $('#participants').html('');
  ...
  */
  socket.on('incomingMessage', function (data) {
   ...
   //$('#messages').prepend().load('/message', {message: message, name: name});
  });
  ...
  */
  function sendMessage() {
   ...
   var name = $('#name').val();
   //if(!name){name === user.id}//get users account name
